    ...
    <div class="body">
        <div class="container" v-for='(item,index) in contents'>
            <div class="introduction">
                ...
                <p class="forWho">适合人群编号: {{item.personGroup}}</p>
            </div>
            <mt-button size="small" @click.native='detail' :id='item.serviceId'>详情</mt-button>
        </div>
    </div>
</div>
</template>
