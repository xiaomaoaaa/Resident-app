	...
	<div class="yndh">
		...
		<div class="contact">
			<div class="contact_top">
				...
				<span class="information">联系方式</span>
			</div>
			<div class="contact_bottom">
				<div> <span class="fame">急诊电话</span> <i class="price">{{list.emergencyNo}}</i> </div>
				<div> <span class="fame">咨询电话</span> <i class="price">{{list.consultNo}}</i> </div>
				<div> <span class="fame">医院传真</span> <i class="price">{{list.fax}}</i> </div>
				<div> <span class="fame">医院网址</span> <i class="price">{{list.homepage}}</i> </div>
			</div>
		</div>
		...
		<div class="contact">
			<div class="contact_top">
				<span class="small"></span>
				<span class="information">交通路线</span>
			</div>
			<div class="route">
				{{list.trafficDesc}}
			</div>
		...
		<div class="contact">
			<div class="contact_top">
				<span class="small"></span>
				<span class="information">医院介绍</span>
			</div>
...
.yndh .contact_top .small{
	width: 0.2rem;
	height: 0.5rem;
	background: #35B46F;
	margin-right: 0.3rem;
}
.yndh .contact_bottom div{
	height: 0.6rem;
	display: flex;
	justify-content: flex-start;
	align-items: center;
...
.yndh  .contact_bottom .price{
	margin-left: 0.5rem;
}
.yndh  .contact .information,.price{
	color: #888;
	font-style:normal
}
.yndh  .contact .route{
