                ...
                <div data-v-1ec0cec4="" class="mint-search">
                    <div class="mint-searchbar">
                        <div class="mint-searchbar-inner">
                            ...
                            <input type="search" @keyup.13="startSearch" placeholder="搜索医院、科室、医生、疾病" class="mint-searchbar-core" autofocus v-model="searchContent">
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        startSearch(){
            ...
            commonAjaxKy(JSON.stringify(params), 'hcn.hospitalResourceManager', 'search').then(res => {
                if (res.code === 200) {
